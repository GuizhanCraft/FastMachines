...
public final class FastInfinityWorkbench extends AbstractFastMachine {
    ...
    private static final ItemStack CRAFT_ITEM = FastMachines.getLocalization().getItem("CRAFT", Material.RESPAWN_ANCHOR);

    public FastInfinityWorkbench(SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
        super(item, recipeType, recipe, 10_000_000, 100_000_000);
    }
