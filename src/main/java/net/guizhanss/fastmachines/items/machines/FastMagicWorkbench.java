...
public final class FastMagicWorkbench extends AbstractFastMachine {

    private static final ItemStack CRAFT_ITEM = FastMachines.getLocalization().getItem(
        "CRAFT", Material.CRAFTING_TABLE);

    public FastMagicWorkbench(SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
